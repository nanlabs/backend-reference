...
| [Python CLI with Click Example](https://github.com/nanlabs/backend-reference/tree/main/examples/cli-click)             | A basic Python CLI tool built with Click, demonstrating how to create commands with help and version options.                                     | _Python3_, _Click_, _CLI_                            |
