...
echo "Setting parameters for ${SERVICE_COMMON}/checkpoints-table-name"
aws ssm put-parameter --name "/${SERVICE_COMMON}/checkpoints-table-name" \
    --value "${CHECKPOINT_TABLE_NAME}" \
    --type "String" \
    --overwrite
