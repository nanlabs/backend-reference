...
if (!danger.github.pr.body || !danger.github.pr.body.includes('## Description')) {
...
if (!isIssueReferenceExempt && !hasIssueReference(prBody) && !hasIssueReference(danger.github.pr.title || '')) {
  fail(
